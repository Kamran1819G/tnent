...
import 'package:tnent/presentation/pages/coupon_pages/share_coupon.dart';

class PercentageCoupon extends StatefulWidget {
  const PercentageCoupon({super.key});

  @override
  State<PercentageCoupon> createState() => _PercentageCouponState();
}

class _PercentageCouponState extends State<PercentageCoupon> {
