...
import 'package:tnent/presentation/pages/store_owner_screens/add_product_screen.dart';
import 'package:tnent/presentation/pages/store_owner_screens/all_products_screen.dart';
import 'package:tnent/presentation/pages/store_owner_screens/category_products_screen.dart';
                        ...
                        GestureDetector(
                          onTap: () async {
                            await Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    AllProductsScreen(storeId: widget.storeId),
                              ),
                            );
                            await _refreshCategories();
                          },
