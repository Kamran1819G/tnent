...
class DeliverAnythingAnywhere extends StatefulWidget {
  ...
  @override
  State<DeliverAnythingAnywhere> createState() => _DeliverAnythingAnywhereState();
}
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              title.contains('to') ? 'See all the deliveries you have received' : 'See all deliveries I have sent',
              style: TextStyle(
